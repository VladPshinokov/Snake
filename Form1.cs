    ...
    public partial class Form1 : Form
    {
        ...
        private void pbSnakeWindow_Paint(object sender, PaintEventArgs e)
        {
            ...
            else
            {
                ...
                string gameOver = "Game over!\nYour final score is " + Settings.Score + "\nFor starting new game press 'Enter' and 'Esc' for ending";
        ...
        private void MovePlayer()
        {
            ...
            for (int i = (Snake.Count - 1); i >= 0; i--)
            {
                if (i == 0)
                {
                    ...
                    int maxXPos = pbSnakeWindow.Size.Width / Settings.Width;
                    int maxYPos = pbSnakeWindow.Size.Height / Settings.Height;
        ...
        private void Eat()
        {
            // Создаем новый объект с координатами последнего элемента змейки, добавляем его в список Snake
